            ...
            <div>
                ...
                <div className="mt-10 ">
                    ...
                    <div className="flex items-center justify-between">
                        <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 font-medium focus:ring-orange-500">Talk to seller</button>
                        <button>
                            <svg
                                className="h-6 w-6 "
